...
credibilityIntervals <- cbind(a, b)
p <- ggplot(credibilityIntervals, aes(scenario, Proportion, colour=CredibleInterval)) + geom_point() +
  theme_minimal() + theme(panel.border=element_rect(fill="transparent"))
print(p)
saveFigure(p, "manuscript-figure-5.png", width=4, height=4)
```
