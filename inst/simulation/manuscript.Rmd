...
meanPopulationSizes  <- getMeanPopulationSizes(cutoffPopulationSizes(populationSizes, cutoff, models=modelNames[1]))
logPopulationSizes <- getLogPopulationSizes(cutoffPopulationSizes(populationSizes, cutoff, models=modelNames[1]))
logMeanPopulationSizes  <- getMeanPopulationSizes(logPopulationSizes)

meanPopulationSizes2000  <- getMeanPopulationSizes(cutoffPopulationSizes(populationSizes2000, 10*cutoff, models=modelNames[1]))
logPopulationSizes2000 <- getLogPopulationSizes(cutoffPopulationSizes(populationSizes2000, 10*cutoff, models=modelNames[1]))
logMeanPopulationSizes2000  <- getMeanPopulationSizes(logPopulationSizes2000)

meanPopulationSizes10Days  <- getMeanPopulationSizes(cutoffPopulationSizes(populationSizes10Days, cutoff, models=modelNames[1]))
logPopulationSizes10Days <- getLogPopulationSizes(cutoffPopulationSizes(populationSizes10Days, cutoff, models=modelNames[1]))
...
table1 <- getPopulationSizesTable(populationSizes, meanPopulationSizes, overEstimate=cutoff, models=modelNames[1])
...
table2 <- getPopulationSizesTable(populationSizes2000, meanPopulationSizes2000, overEstimate=10*cutoff, models=modelNames[1])
...
table3 <- getPopulationSizesTable(populationSizes10Days, meanPopulationSizes10Days, overEstimate=cutoff, models=modelNames[1])
...
pc2a <- getPopulationCorrelations(scenarios="Acombined", modelNames=modelNames[1], cutoff=cutoff)
pc2b <- getPopulationCorrelations(scenarios="Bcombined", modelNames=modelNames[1], cutoff=cutoff)
pc2c <- getPopulationCorrelations(scenarios="Ccombined", modelNames=modelNames[1], cutoff=cutoff)
pc2d <- getPopulationCorrelations(scenarios="Dcombined", modelNames=modelNames[1], cutoff=cutoff)
pc2e <- getPopulationCorrelations(scenarios="Ecombined", modelNames=modelNames[1], cutoff=cutoff)
pc2f <- getPopulationCorrelations(scenarios="Fcombined", modelNames=modelNames[1], cutoff=cutoff)
