...
p <- p + scale_fill_gradientn(colours=terrain.colors(100), na.value="transparent",
                       guide=guide_legend(title=expression(paste("Log population density ", (individuals/km^2)))), trans="log10",
...
plotLogPopulationSize <- function(size, modelName, case, xlim, ylim) {
  ...
  p <- p + facet_wrap(~Scenario) +
    ...
    xlab("Log true population size") + ylab("Log estimated population size") + ggtitle(paste("Case:", case, " Model:", prettyModelName(modelName[1]))) +
...
p <- plotLogPopulationSize(subset(logPopulationSizes, modelName==modelNames[1]), modelName=modelNames[1], "a", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3a1.png")
p <- plotLogPopulationSize(subset(logPopulationSizes, modelName==modelNames[3]), modelName=modelNames[3], "a", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3a2.png")
p <- plotLogPopulationSize(subset(logPopulationSizes, modelName==modelNames[4]), modelName=modelNames[4], "a", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3a3.png")

p <- plotLogPopulationSize(subset(logPopulationSizes2000, modelName==modelNames[1]), modelName=modelNames[1], "b", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3b1.png")
p <- plotLogPopulationSize(subset(logPopulationSizes2000, modelName==modelNames[3]), modelName=modelNames[3], "b", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3b2.png")
p <- plotLogPopulationSize(subset(logPopulationSizes2000, modelName==modelNames[4]), modelName=modelNames[4], "b", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3b3.png")

p <- plotLogPopulationSize(subset(logPopulationSizes10Days, modelName==modelNames[1]), modelName=modelNames[1], "c", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3c1.png")
p <- plotLogPopulationSize(subset(logPopulationSizes10Days, modelName==modelNames[3]), modelName=modelNames[3], "c", xlim=xlim, ylim=ylim)
saveFigure(p, "manuscript-figure-3c2.png")
p <- plotLogPopulationSize(subset(logPopulationSizes10Days, modelName==modelNames[4]), modelName=modelNames[4], "c", xlim=xlim, ylim=ylim)
...
rer.stat <- function(x) data.frame(SizeCount=mean(x$intersections/x$Observed), SizeCountSD=sd(x$intersections/x$Observed))
...
saveFigure(p, "manuscript-figure-4x.png", height=7.87/2.5)
