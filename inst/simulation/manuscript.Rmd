...
logTable1 <- getPopulationSizesTable(logPopulationSizes, logMeanPopulationSizes, overEstimate=log10(cutoff+1), models=modelNames[1])
...
plotCIProportions <- function(credibilityIntervals) {
  ...
  p <- ggplot(credibilityIntervals, aes(scenario, Proportion, shape=CI, colour=modelName)) +
    ...
    scale_colour_manual("Model", values=c("black", "gray26", "gray80"), labels=modelLabels) +
