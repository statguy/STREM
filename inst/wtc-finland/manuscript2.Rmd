...
x <- SpaceTimeModels::smoothContinuousSubsets(r=forest, coords=coords, kernel=SpaceTimeModels::ExponentialKernel$new(), scales=c(125, 1000), .parallel=T)
...
colnames(r1) <- c("x","y","value")
coords <- raster::xyFromCell(r, cell=1:ncell(r))
x <- SpaceTimeModels::smoothContinuousSubsets(r=r, coords=coords, kernel=SpaceTimeModels::ExponentialKernel$new(), scales=c(2000), .parallel=T)
