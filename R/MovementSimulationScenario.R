...
MovementSimulationScenarioIntensive <- setRefClass(
  ...
  methods = list(
    initialize = function(nAgents=as.integer(600), nIterations=as.integer(1), years=as.integer(1), days=as.integer(60), stepIntervalHours=0.1, runParallel=T, isTest=F, ...) {
